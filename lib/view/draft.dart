    ...
    //                       _buildTableRow("Número de Serie de UAS",
    //                           uasSerialNumberController.text,
    //                           grey: true),
    //                       _buildTableRow("Fecha de registro",
    ...
    //                           grey: false),
    //                       _buildTableRow(
    //                           "Nacionalidad", buyerNationalityController.text,
    //                           grey: true),
    //                       _buildTableRow("Teléfono", buyerPhoneController.text,
    //                           grey: false),
    //                       _buildTableRow(
    //                           "Correo Electrónico", buyerEmailController.text,
    //                           grey: true),
    //                       _buildTableRow(
    //                           "Dirección", buyerAddressController.text,
    //                           grey: false),
    //                       _buildTableRow(
    //                           "Código Postal", buyerZipCodeController.text,
    //                           grey: true),
    //                       _buildTableRow(
    //                           "Municipio", buyerMunicipalityController.text,
    //                           grey: false),
    //                       _buildTableRow(
    //                           "Provincia", buyerProvinceController.text,
    //                           grey: true),
    //                       _buildTableRow("País", buyerCountryController.text,
    //                           grey: true),
    //                       _buildTableRow("Método de Notificación",
    //                           notificationMethodController.text,
    //                           grey: false),
    //                       _buildTableRow(
    //                           "Marca y Modelo del UAS", uasModelController.text,
    //                           grey: true),
    //                       _buildTableRow(
    //                           "Método de Adquisición", "WWW.COMPRODRONE.COM",
    //                           grey: false),
    //                       _buildTableRow("Observaciones", "", grey: true),
    //                     ],
    //                   ),
    //                 ],
    //               ),
    ...
    //               ),
    //             ),
    //             // Spacer and validation text
    //             pw.SizedBox(height: 20),
    //             pw.Text(
    //               'Los documentos emitidos por COMPRODRONE tienen un código de verificación para que el destinatario pueda verificar su autenticidad. '
    //               'Este código se puede encontrar en la parte inferior del documento. Por lo tanto, el Código Seguro de Verificación (CSV) o Código de Identificación del Documento (CID) permite verificar la integridad de la copia de este documento.',
    //               textAlign: pw.TextAlign.center,
    ...
    //             pw.Container(
    //               alignment: pw.Alignment.center,
    //               child: pw.Text("VENTA NO. 1 Tipo de registro",
    //                   textAlign: pw.TextAlign.center),
    //             ),
    //             pw.SizedBox(height: 20),
    //             pw.Text(
...
//                                     style: pw.TextStyle(fontSize: 12),
//                                   ),
//                                   if (notificationMethodController.text ==
//                                       'email')
//                                     pw.Icon(
//                                       pw.IconData(
//                                         0xe5ca,
